(function () {
  const TRA_SEGMENT_GROUPS = [
    {
      ...
      segments: [
        ...
        },
        {
          ...
          title: "屏東線",
          subtitle: "高雄 - 枋寮",
          stations: ["高雄", "民族", "科工館", "正義", "鳳山", "後庄", "九曲堂", "六塊厝", "屏東", "歸來", "麟洛", "西勢", "竹田", "潮州", "南方小站", "潮州基地", "崁頂", "南州", "鎮安", "林邊", "佳冬", "東海", "枋寮"],
          includeAny: ["民族", "科工館", "正義", "鳳山", "後庄", "九曲堂", "六塊厝", "屏東", "歸來", "麟洛", "西勢", "竹田", "潮州", "南方小站", "潮州基地", "崁頂", "南州", "鎮安", "林邊", "佳冬", "東海"],
        },
      ],
    },
    {
      ...
      segments: [
        ...
        },
        {
          ...
          title: "南迴線",
          subtitle: "枋寮 - 臺東",
          stations: ["枋寮", "加祿", "內獅", "枋山", "枋野", "中央號誌", "古莊", "大武", "瀧溪", "金崙", "太麻里", "知本", "康樂", "臺東"],
          includeAny: ["加祿", "內獅", "枋山", "枋野", "中央號誌", "古莊", "大武", "瀧溪", "金崙", "太麻里", "知本", "康樂"],
        },
      ],
    },
    {
  ...
  const TRA_CUMULATIVE_MILEAGE_SPECS = [
    ...
    },
    {
      ...
      stations: [
        ...
        ["竹田", 31.9], ["潮州", 35.9], ["南方小站", 37.8], ["潮州基地", 38.5], ["崁頂", 40.8], ["南州", 43.2], ["鎮安", 47.0], ["林邊", 50.1],
    ...
    },
    {
      id: "south-link",
      stations: [
        ["枋寮", 0.0], ["加祿", 5.3], ["內獅", 8.8], ["枋山", 13.6], ["枋野", 20.5], ["中央號誌", 23.6], ["古莊", 40.5], ["大武", 43.8], ["瀧溪", 55.5],
  ...
  const TRA_SUPPLEMENTAL_STATION_GEO = new Map([
    ["枋野", { id: "5170", name: "枋野", lat: 22.279722, lon: 120.718611 }],
    ["中央號誌", { id: "5175", name: "中央號誌", lat: 22.278889, lon: 120.743056 }],
    ["古莊", { id: "5180", name: "古莊", lat: 22.348333, lon: 120.881667 }],
  ]);

  function getTraSupplementalStationGeo(stationName) {
    const normalized = normalizeTraStation(stationName);
    if (!normalized) return null;
    const item = TRA_SUPPLEMENTAL_STATION_GEO.get(normalized);
